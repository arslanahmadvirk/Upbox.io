...
<head>
	...
	<link rel="shortcut icon" href="assets/media/logos/upbox-favicon.ico" />
	<!--begin::Fonts-->
				...
				<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Blog</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
						...
						<div class="card">
							...
							<div class="card-body p-lg-20">
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div
												...
												<div class="mb-5">
													...
													<a href=<?php echo 'pages/blog/post.php?title=Admin+Panel+How+To+Get+Started+Tutorial+Create+easy+customizable+applications&pic=assets/media/avatars/300-9.jpg&name=David+Morgan&date=Apr+27+2021&category=TUTORIALS
														';?>
														class="fs-2 text-dark fw-bolder text-hover-primary text-dark lh-base"
														>Admin
														Panel - How To Get Started Tutorial.
														<br />Create easy customizable applications</a>
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 text-gray-600 text-dark mt-4">We’ve been
														focused on making the from v4 to v5 but we have also not been
														afraid to step away been focused on from v4 to v5 speaker
														approachable making focused a but from a step away afraid to
														step away been focused Writing a blog post is a little like
														driving; you can study the highway code (or read articles
														telling you how to write a blog post) for months, but nothing
														can prepare you for the real thing like getting behind the wheel
													</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
												...
												<div class="d-flex flex-stack flex-wrap">
													...
													<div class="d-flex align-items-center pe-2">
														...
														<div class="fs-5 fw-bolder">
															<a href="../../demo18/dist/pages/user-profile/overview.html"
													...
													<!--begin::Label-->
													<span
														class="badge badge-light-primary fw-bolder my-2">TUTORIALS</span>
													<!--end::Label-->
												</div>
												<!--end::Footer-->
											</div>
										...
										<div class="col-md-6 justify-content-between d-flex flex-column">
											...
											<div class="ps-lg-6 mb-16 mt-md-0 mt-17">
												...
												<div class="mb-6">
													<!--begin::Title-->
													<a href=<?php echo 'pages/blog/post.php?title=Bootstrap+Admin+Theme+How+To+Get+Started+Tutorial+Create+customizable+applications&pic=assets/media/avatars/300-20.jpg&name=Jane+Miller&date=Apr+27+2021&category=BLOG
														';?>
														class="fw-bolder text-dark mb-4 fs-2 lh-base text-hover-primary">Bootstrap
														Admin Theme - How To Get Started Tutorial. Create customizable
														applications</a>
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 mt-4 text-gray-600 text-dark">We’ve been
														focused on making the from v4 to v5 a but we’ve also not been
														afraid to step away been focused on from v4 to v5 speaker
														approachable making focused</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
												<!--begin::Footer-->
											...
											<div class="ps-lg-6 mb-16">
												...
												<div class="mb-6">
													<!--begin::Title-->
													<a href=<?php echo 'pages/blog/post.php?title=Angular+Admin+Theme+How+To+Get+Started+Tutorial&pic=assets/media/avatars/300-9.jpg&name=Cris+Morgan&date=Mar+14+2021&category=TUTORIALS';?>
														class="fw-bolder text-dark mb-4 fs-2 lh-base text-hover-primary">Angular
														Admin Theme - How To Get Started Tutorial.</a>
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 mt-4 text-gray-600 text-dark">We’ve been
														focused on making the from v4 to v5 a but we’ve also not been
														afraid to step away</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
												<!--begin::Footer-->
											...
											<div class="ps-lg-6">
												...
												<div class="mb-6">
													<!--begin::Title-->
													<a href=<?php echo 'pages/blog/post.php?title=React+Admin+Theme+How+To+Get+Started+Tutorial+Create+best+applications&pic=assets/media/avatars/300-19.jpg&name=Cris+Morgan&date=Mar+14+2021&category=NEWS';?>
														class="fw-bolder text-dark mb-4 fs-2 lh-base text-hover-primary">React
														Admin Theme - How To Get Started Tutorial. Create best
														applications</a>
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 mt-4 text-gray-600 text-dark">We’ve been
														focused on making the from v4 to v5 but we’ve also not been
														afraid to step away been focused</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
												<!--begin::Footer-->
												<div class="d-flex flex-stack flex-wrap">
													...
													<div class="d-flex align-items-center pe-2">
														<!--begin::Avatar-->
														<div class="symbol symbol-35px symbol-circle me-3">
															<img src="assets/media/avatars/300-19.jpg" class=""
																alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
										...
										<div class="col-md-4">
											...
											<div class="card-xl-stretch me-md-6">
												...
												<div class="m-0">
													...
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 text-gray-600 text-dark my-4">We’ve been
														focused on making a the from also not been afraid to and step
														away been focused create eye</div>
													<!--end::Text-->
													<!--begin::Content-->
								...
								<div class="mb-17">
									...
									<div class="d-flex flex-stack mb-5">
										<!--begin::Title-->
										<h3 class="text-dark">Current Bundles</h3>
										<!--end::Title-->
										<!--begin::Link-->
										...
										<div class="col-md-4">
											...
											<div class="card-xl-stretch me-md-6">
												...
												<div class="mt-5">
													<!--begin::Title-->
													<a href="#"
														class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">25
														Products Mega Bundle with 50% off discount amazing</a>
													<!--end::Title-->
													<!--begin::Text-->
													<div class="fw-bold fs-5 text-gray-600 text-dark mt-3">We’ve been
													...
													<div class="fs-6 fw-bolder mt-5 d-flex flex-stack">
														<!--begin::Label-->
														<span
															class="badge border border-dashed fs-2 fw-bolder text-dark p-2">
									...
									<div class="row g-10 row-cols-2 row-cols-lg-5">
										...
										<div class="col">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
												...
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
													style="background-image:url('assets/media/stock/900x600/16.jpg')">
												</div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
										...
										<div class="col">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
												...
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
													style="background-image:url('assets/media/stock/900x600/13.jpg')">
												</div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
										...
										<div class="col">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
												...
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
													style="background-image:url('assets/media/stock/900x600/15.jpg')">
												</div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
										...
										<div class="col">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
												...
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
													style="background-image:url('assets/media/stock/900x600/12.jpg')">
												</div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
