				...
				<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Security</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
											...
											<ul class="nav nav-tabs nav-line-tabs nav-stretch border-transparent fs-5 fw-bolder"
												...
												<li class="nav-item">
													<a class="nav-link text-active-primary active"
														...
														href="#kt_security_summary_tab_pane_hours">12 Hours</a>
												</li>
												<li class="nav-item">
									...
									<div class="card-body pt-7 pb-0 px-0">
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade active show"
												id="kt_security_summary_tab_pane_hours" role="tabpanel">
												<!--begin::Row-->
												<div class="row p-0 mb-5 px-9">
													...
													<div class="col">
														<div
															...
															<span class="fs-4 fw-bold text-success d-block">User
																Sign-in</span>
															<span class="fs-2hx fw-bolder text-gray-900"
													...
													<div class="col">
														<div
															class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
															<span class="fs-4 fw-bold text-primary d-block">Admin
																Sign-in</span>
															<span class="fs-2hx fw-bolder text-gray-900"
																data-kt-countup="true"
													...
													<div class="col">
														<div
															class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
															<span class="fs-4 fw-bold text-danger d-block">Failed
																Attempts</span>
															<span class="fs-2hx fw-bolder text-gray-900"
																data-kt-countup="true"
												...
												<div class="row p-0 mb-5 px-9">
													...
													<div class="col">
														<div
															...
															<span class="fs-4 fw-bold text-success d-block">User
																Sign-in</span>
															<span class="fs-2hx fw-bolder text-gray-800"
																data-kt-countup="true"
												...
												<div class="pt-2">
													...
													<div class="tab-content">
														...
														<div class="tab-pane fade"
															...
															role="tabpanel">
															<!--begin::Chart-->
															<div id="kt_security_summary_chart_day_clients"
																style="height: 300px"></div>
															<!--end::Chart-->
														</div>
													</div>
											...
											<!--end::Tab panel-->
											<!--begin::Tab panel-->
											<div class="tab-pane fade" id="kt_security_summary_tab_pane_week"
												role="tabpanel">
												<!--begin::Row-->
												<div class="row p-0 mb-5 px-9">
													<!--begin::Col-->
													<div class="col">
														<div
															class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
															<span class="fs-lg-4 fs-6 fw-bold text-success d-block">User
																Sign-in</span>
															<span class="fs-lg-2hx fs-2 fw-bolder text-gray-800"
																data-kt-countup="true"
													...
													<div class="col">
														<div
															class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
															<span
																class="fs-lg-4 fs-6 fw-bold text-primary d-block">Admin
																Sign-in</span>
															<span class="fs-lg-2hx fs-2 fw-bolder text-gray-800"
																data-kt-countup="true"
													...
													<div class="col">
														<div
															class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
															<span
																class="fs-lg-4 fs-6 fw-bold text-danger d-block">Failed
																Attempts</span>
															<span class="fs-lg-2hx fs-2 fw-bolder text-gray-800"
																data-kt-countup="true"
												...
												<div class="pt-2">
													...
													<div class="d-flex align-items-center pb-9 px-9">
														...
														<ul class="nav nav-pills nav-line-pills border rounded p-1">
															<li class="nav-item me-2">
																<a class="nav-link btn btn-active-light py-2 px-5 fs-6 btn-active-color-gray-700 btn-color-gray-400 fw-bold active"
																	data-bs-toggle="tab"
																	id="kt_security_summary_tab_week_agents"
																	href="#kt_security_summary_tab_pane_week_agents">Agents</a>
															</li>
															<li class="nav-item">
																<a class="nav-link btn btn-active-light py-2 px-5 btn-active-color-gray-700 btn-color-gray-400 fs-6 fw-bold"
																	data-bs-toggle="tab"
													...
													<div class="tab-content">
														...
														<div class="tab-pane fade"
															...
															role="tabpanel">
															<!--begin::Chart-->
															<div id="kt_security_summary_chart_week_clients"
																style="height: 300px"></div>
															<!--end::Chart-->
														</div>
													</div>
							...
							<div class="col-xxl-4">
								...
								<div class="card card-xxl-stretch-50 mb-5 mb-xl-10">
									...
									<div class="card-body pt-5">
										<!--begin::Carousel-->
										<div id="kt_security_recent_alerts"
											...
											<div class="carousel-inner pt-6">
												...
												<div class="carousel-item active">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fs-5 fw-bolder text-dark text-hover-primary">Latest
																Announcements</a>
															<p class="text-gray-600 fs-6 fw-bold pt-3 mb-0">In the last
																year, you’ve probably had to adapt to new ways of living
																and working.</p>
														</div>
														<!--end::Description-->
														<!--begin::Summary-->
														<div class="d-flex flex-stack pt-8">
															<span
																class="badge badge-light-primary fs-7 fw-bolder me-2">Jun
																10, 2021</span>
												...
												<div class="carousel-item">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fw-bolder text-dark text-hover-primary">Login
																Attempt Failed</a>
															<p class="text-gray-600 fs-6 fw-bold pt-3 mb-0">As we
																approach one year of working remotely, we wanted to take
																a look back and share some ways teams around the world
														...
														<div class="d-flex flex-stack pt-8">
															<span
																...
																05, 2021</span>
															<a href="#"
																class="btn btn-light btn-sm btn-color-muted fs-7 fw-bolder px-5">Join</a>
														</div>
														<!--end::Summary-->
													</div>
													<!--end::Wrapper-->
												...
												<div class="carousel-item">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fw-bolder text-dark text-hover-primary">Top Picks
																For You</a>
															<p class="text-gray-600 fs-6 fw-bold pt-3 mb-0">Today we are
																excited to share an amazing certification opportunity
																which is designed to teach you everything</p>
														</div>
														<!--end::Description-->
														<!--begin::Summary-->
														<div class="d-flex flex-stack pt-8">
															<span
																class="badge badge-light-primary fs-7 fw-bolder me-2">Sep
																11, 2021</span>
															<a href="#"
																class="btn btn-light btn-sm btn-color-muted fs-7 fw-bolder px-5">Collaborate</a>
														</div>
														<!--end::Summary-->
													</div>
													<!--end::Wrapper-->
											...
											<div class="d-flex flex-stack align-items-center flex-wrap">
												...
												<ol class="p-0 m-0 carousel-indicators carousel-indicators-dots">
													<li data-bs-target="#kt_security_guidelines" data-bs-slide-to="0"
														class="ms-1 active"></li>
													<li data-bs-target="#kt_security_guidelines" data-bs-slide-to="1"
														class="ms-1"></li>
													<li data-bs-target="#kt_security_guidelines" data-bs-slide-to="2"
														class="ms-1"></li>
												</ol>
												<!--end::Carousel Indicators-->
											</div>
											...
											<div class="carousel-inner pt-6">
												...
												<div class="carousel-item active">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fs-5 fw-bolder text-dark text-hover-primary">Get
														...
														<!--begin::Summary-->
														<div class="d-flex flex-stack pt-8">
															<span class="text-muted fw-bold fs-6 pe-2">34, Soho Avenue,
																Tokio</span>
												...
												<div class="carousel-item">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fw-bolder text-dark text-hover-primary">Security
																Policy Update</a>
															<p class="text-gray-600 fs-6 fw-bold pt-3 mb-0">As we
																approach one year of working remotely, we wanted to take
																a look back and share some ways teams around the world
														...
														<div class="d-flex flex-stack pt-8">
															<span
																...
																05, 2021</span>
															<a href="#"
																class="btn btn-light btn-sm btn-color-muted fs-7 fw-bolder px-5">Explore</a>
														</div>
														<!--end::Summary-->
													</div>
													<!--end::Wrapper-->
												...
												<div class="carousel-item">
													...
													<div class="carousel-wrapper">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="fw-bolder text-dark text-hover-primary">Terms Of
																Use Document</a>
															<p class="text-gray-600 fs-6 fw-bold pt-3 mb-0">Today we are
																excited to share an amazing certification opportunity
																which is designed to teach you everything</p>
														...
														<div class="d-flex flex-stack pt-8">
															<span
																...
																10, 2021</span>
															<a href="#"
																class="btn btn-light btn-sm btn-color-muted fs-7 fw-bolder px-5">Discover</a>
														</div>
														<!--end::Summary-->
													</div>
													<!--end::Wrapper-->
									...
									<table
										...
										<tbody class="fw-6 fw-bold text-gray-600">
											<tr>
												<td class="ps-9">
													<span
														class="badge badge-light-success fs-7 fw-bolder">License</span>
												</td>
												<td class="ps-0">
												...
												<td class="ps-5">
													<button type="button" data-action="copy"
														class="btn btn-active-color-primary btn-icon btn-sm btn-outline-light d-">
											...
											<tr>
												...
												<td class="ps-0">
													<a href="" class="text-hover-primary text-gray-600">ReXe:
														Workstation 29</a>
												</td>
												<td>236.125.56.78</td>
												<td>3 mins ago</td>
											...
											<tr>
												<td class="ps-9">
													<span class="badge badge-light-warning fs-7 fw-bolder">To be
														Paid</span>
												</td>
												<td class="ps-0">
