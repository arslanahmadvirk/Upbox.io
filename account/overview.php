				...
				<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						...
						<div class="page-title d-flex flex-column me-3">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Profile</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
					...
					<div class="content flex-row-fluid" id="kt_content">
						...
						<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
							...
							<div class="card-header cursor-pointer">
								...
								<!--end::Card title-->
								<!--begin::Action-->
								<a href="../../demo18/dist/account/settings.html"
							...
							<div class="card-body p-9">
								...
								<div class="row mb-7">
									...
									<div class="col-lg-8">
										<a href="#"
											class="fw-bold fs-6 text-gray-800 text-hover-primary">keenthemes.com</a>
									</div>
									<!--end::Col-->
								</div>
								<!--end::Input group-->
									...
									<div class="d-flex flex-stack flex-grow-1">
										...
										<div class="fw-bold">
											...
											<div class="fs-6 text-gray-700">Your payment was declined. To start using
												tools, please
												<a class="fw-bolder" href="../../demo18/dist/account/billing.html">Add
													Payment Method</a>.
											</div>
										</div>
										<!--end::Content-->
