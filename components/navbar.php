				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
					...
					<div class="container-xxl d-flex align-items-center flex-lg-stack">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-2 me-lg-5">
							...
							<div class="flex-grow-1">
								...
								<a href=<?php echo "index.php" ?>>
									<img alt="Logo" src="assets/media/logos/upbox-logo.svg" class="h-30px h-lg-35px" />
								</a>
								<!--end::Header Logo-->
							</div>
							<!--end::Wrapper-->
									...
									<div data-kt-search-element="content"
										...
										<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
											...
											<div class="d-flex justify-content-end">
												...
												<a href="../../demo18/dist/pages/search/horizontal.html"
						...
						<div class="d-flex align-items-stretch flex-shrink-0">
							...
							<!--begin::Theme mode d-flex -->
							<div class="d-none align-items-center ms-1 ms-lg-3">
								<!--begin::Theme mode docs-->
								<div class="btn btn-color-gray-800 btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
							...
							<div class="d-flex align-items-center ms-1 ms-lg-3">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
									...
									<div class="menu-item px-5">
										<a href=<?php echo 'account/overview.php';?> class="menu-link px-5">My
											Profile</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href=<?php echo 'apps/projects/list.php';?> class="menu-link px-5">
									...
									<div class="menu-item px-5 my-1">
										<a href=<?php echo 'account/settings.php';?> class="menu-link px-5">Account
											Settings</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href=<?php echo 'authentication/layouts/basic/sign-in.php';?> class="menu-link px-5">Sign
											Out</a>
									</div>
									<!--end::Menu item-->
								</div>
							...
							<div class="d-flex align-items-center ms-1 ms-lg-3">
								...
								<div class="position-relative btn btn-color-gray-800 btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
									id="kt_drawer_chat_toggle_1">
									<a href=<?php echo 'apps/inbox/listing.php';?>>
									<!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
									<span class="svg-icon svg-icon-2">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											viewBox="0 0 24 24" fill="none">
							...
							<div class="d-flex align-items-center ms-1 ms-lg-3">
								...
								<div
									class="btn btn-icon btn-primary position-relative w-30px h-30px w-md-40px h-md-40px">
									3</div>
								<!--end::Drawer wrapper-->
							</div>
							<!-- end::Chat -->
